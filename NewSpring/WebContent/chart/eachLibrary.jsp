...
<body style="overflow-y:auto;" scroll="no">
	<div id="chartdiv1" style="width:100%; height:33%; top:0px; left:0px; position:absolute; border:1px solid #FCDD44;">
	</div>
	<div id="chartdiv2" style="width:100%; height:34%; top:33%; left:0px; position:absolute; border:1px solid #FCDD44;">
	</div>
	<div id="chartdiv3" style="width:100%; height:33%; top:67%; left:0px; position:absolute; border:1px solid #FCDD44;">
	</div>
...
<script type="text/javascript">
	...
	function showSecondes() {
		location.href = "<%=request.getContextPath()%>/EachLibraryPie";
	}
	...
	var data = ${message};
	chart1.setDataXML(data.FirstReadingRoomPie);
	chart1.render("chartdiv1");
	chart2.setDataXML(data.DigitalReadingRoomPie);
	chart2.render("chartdiv2");
	chart3.setDataXML(data.SelfStudyRoomPie);
