...
<body style="overflow-y:auto" scroll="no">
	...
	<script type="text/javascript">
	  var timer = window.setInterval(showSecondes,300000);
	...
	var data = ${message};
	chart1.setDataXML(data.FirstBathroom);
	chart1.render("chartdiv1");
	chart2.setDataXML(data.SecondBathroom);
	chart2.render("chartdiv2");
	chart3.setDataXML(data.ThirdBathroom);
