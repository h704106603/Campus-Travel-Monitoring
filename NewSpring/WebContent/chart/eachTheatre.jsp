...
<script type="text/javascript">
	...
	function showSecondes() {
		location.href = "<%=request.getContextPath()%>/EachTheatrePie";
	}
	...
	var data = ${message};
	chart1.setDataXML(data.eachTheatre130);
	chart1.render("chartdiv1");
	chart2.setDataXML(data.eachTheatre146);
	chart2.render("chartdiv2");
	chart3.setDataXML(data.eachTheatre346);
