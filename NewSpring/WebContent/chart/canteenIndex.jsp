...
<body style="background-color: #000000">
  ...
  <body class="tm-gray-bg">
 	...
 	<div id="eachLibraryPie" style=" width:100%; height:100%;position:absolute; top: 120%; left:0%; ">			
 			<iframe  src="<%=request.getContextPath()%>/EachCanteenPie" style="width:100%; height:100%;border-width: 0px;"></iframe>
 	</div>
 	<div id="libraryBar" style=" width:100%; height:100%;position:absolute; top: 220%; left:0%; ">			
 			<iframe  src="<%=request.getContextPath()%>/CanteenBar" style="width:100%; height:100%;border-width: 0px;"></iframe>
 	</div>
