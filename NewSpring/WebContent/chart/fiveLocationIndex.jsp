...
<body style="background-color: #000000">
  ...
  <body class="tm-gray-bg">
 	...
 	<div id="library" style=" width:100%; height:50%;position:absolute; top: 20%; left:0%; ">		
 	...
 	<div id="bathroom" style=" width:100%; height:50%;position:absolute; top: 70%; left:50%; ">
 	...
 	<div id="canteen" style=" width:100%; height:50%;position:absolute; top: 120%; left:0%; ">			
 			<iframe  src="<%=request.getContextPath()%>/AllCanteenPie" style="width:100%; height:100%;border-width: 0px;"></iframe>
 	</div>
 	<div id="theatre" style=" width:100%; height:50%;position:absolute; top: 170%; left:0%; ">			
 			<iframe  src="<%=request.getContextPath()%>/AllTheatrePie" style="width:100%; height:100%;border-width: 0px;"></iframe>
 	</div>
 	<div id="classroom" style=" width:100%; height:100%;position:absolute; top: 220%; left:0%; ">			
