...
<title>食堂近一小时人数明细(刷新周期5分钟)</title>
...
<body style="overflow-y:auto" scroll="no">
	...
	<script type="text/javascript">
	  var timer = window.setInterval(showSecondes,30000);
		function showSecondes() {
			location.href = "<%=request.getContextPath()%>/CanteenBar";
		}
	...
	var data = ${message};
	chart1.setDataXML(data.FirstCanteen);
	chart1.render("chartdiv1");
	chart2.setDataXML(data.SecondCanteen);
	chart2.render("chartdiv2");
	chart3.setDataXML(data.ThirdCanteen);
