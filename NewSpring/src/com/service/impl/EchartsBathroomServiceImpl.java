...
public class EchartsBathroomServiceImpl implements EchartsBathroomService{
	...
	public String BathroomBar(String id){
		if(id=="1"){
			return showBar("近一小时第一浴室人数明细",bathroomBarSql,"1");
			
		}
		else{

			return showBar("近一小时第二浴室人数明细",bathroomBarSql,"2");
		}
...
//		bar1.markPoint(markPoint).itemStyle(placeHolderStyle);
		...
		try {
			Date dt=new Date();
			String sql = ResourceUtils.getStringFromResource(bathroomBarSql);
