...
public class EchartsLibraryServiceImpl implements EchartsLibraryService{
    ...
    public String LibraryBar(String id){
        if(id=="1"){
            return showBar("近两小时阅览室人数明细",bathroomBarSql,"1");
            
        }
        else{

            return showBar("近两小时阅览室人数明细",bathroomBarSql,"2");
        }
