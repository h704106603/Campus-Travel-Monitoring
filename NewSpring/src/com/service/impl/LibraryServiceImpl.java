...
public class LibraryServiceImpl implements LibraryService{
    ...
    public Map<String,Object> getPieData(boolean flag){
        ...
        try{
            String re = getPieResult("图书馆当前人数分布情况",allLibrarySql);
            reMap.put("allLibrary", re);
        }catch(Exception e){
            e.printStackTrace();
        }
        
        try{
            String re = getEachPieResult("一层阅览室当前人数分布情况",eachLibrarySql);
            reMap.put("FirstReadingRoomPie", re);
        }catch(Exception e){
            e.printStackTrace();
        }
        
        try{
            String re = getEachPieResult("电子阅览室当前人数分布情况",eachLibrarySql);
            reMap.put("DigitalReadingRoomPie", re);
        }catch(Exception e){
            e.printStackTrace();
        }
        
        try{
            String re = getEachPieResult("自习室当前人数分布情况",eachLibrarySql);
            reMap.put("SelfStudyRoomPie", re);
        }catch(Exception e){
            e.printStackTrace();
        }
